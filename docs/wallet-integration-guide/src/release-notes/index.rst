...
*using the new functionality like. An example of the complete setup can be found here:* `Wallet SDK example 18 <https://github.com/canton-network/wallet/blob/main/docs/wallet-integration-guide/examples/scripts/18-merge-delegation-proposal.ts>`__
