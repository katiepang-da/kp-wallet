...
is to expose a dApp API (OpenRPC spec can be found here: https://github.com/canton-network/wallet/blob/main/api-specs/openrpc-dapp-api.json ).
...
.. Relies on https://github.com/canton-network/wallet/issues/1538
